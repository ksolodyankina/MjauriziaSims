...
namespace Domain.Migrator
{
    public class Migrator
    {
        ...
        private static readonly Goal[] Goals = new [] {
            ...
            new Goal { Code = "party-goer", IsChild = false, Title = "goal_partyGoer"},
        ...
        private static readonly Preference[] Preferences = new[]
        {
            ...
            new Preference { Category = (Preference.Categories)2, Code = "cross-stitch", Title = "preference_cross-stitch" },
            ...
            new Preference { Category = (Preference.Categories)1, Code = "hip-hop", Title = "preference_hip-hop" },
            ...
            new Preference { Category = (Preference.Categories)2, Code = "research-debate", Title = "preference_research-debate" },
        ...
        private static readonly Msg[] Messages = new[] {
            ...
            new Msg {Code = "err_emailNotConfirmed", MsgRu = "Пожалуйста, подтвердите свой имейл", MsgEn = "You should confirm your email first"},
            new Msg {Code = "err_incorrectPass", MsgRu = "Неверный логин или пароль", MsgEn = "Incorrect login or password"},
            new Msg {Code = "registrationSubject", MsgRu = "MjauriziaSims: Регистрация", MsgEn = "Registration at MjauriziaSims"},
            new Msg {Code = "registrationText", MsgRu = "Пройдите по ссылке, чтобы подтвердить свой имейл:\n <url>", MsgEn = "To confirm your email follow the link:\n <url>"},
            new Msg {Code = "err_registration", MsgRu = "Пользователь с таким логином уже существует", MsgEn = "User with this login already exists"},
            new Msg {Code = "err_recovery", MsgRu = "Не существует пользователя с таким имейлом", MsgEn = "No user with such email was register"},
            new Msg {Code = "recoveryText", MsgRu = "Перейдите по ссылке, чтобы сбросить пароль: <url>", MsgEn = "Follow link to set new password:\n <url>"},
            new Msg {Code = "recoverySubject", MsgRu = "MjauriziaSims: восстановление пароля", MsgEn = "Reset password for MjauriziaSims"},
            new Msg {Code = "err_PassReset", MsgRu = "Неверная ссылка. Пожалуйста, попробуйте восстановить пароль еще раз.", MsgEn = "Your link is wrong. Please, try to reset password again."},
        };
